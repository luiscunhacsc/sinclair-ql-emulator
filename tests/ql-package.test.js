...
function qdosZipExtra({ type = 1, dataSpace = 0 } = {}) {
  const extra = new Uint8Array(76);
  extra[0] = 0x4a;
  extra[1] = 0xfb;
  extra[2] = 72;
  extra.set(new TextEncoder().encode("QZHDQDOS"), 4);
  extra[17] = type;
  extra[18] = (dataSpace >>> 24) & 0xff;
  extra[19] = (dataSpace >>> 16) & 0xff;
  extra[20] = (dataSpace >>> 8) & 0xff;
  extra[21] = dataSpace & 0xff;
  return extra;
}
